...
const Competences = () => {
  ...
  const outils = [
    ...
    <div key="Vite" className="skill-row">
      ...
      <meter min="0" max="100" value={80} aria-label="Vite 80%" className="skill-meter" />
      <span className="skill-level">80%</span>
    </div>,
    <div key="Figma" className="skill-row">
      <span className="skill-name">Figma</span>
      <meter min="0" max="100" value={88} aria-label="Figma 88%" className="skill-meter" />
    ...
    <div key="Lighthouse, WAVE" className="skill-row">
      ...
      <meter min="0" max="100" value={90} aria-label="Lighthouse, WAVE 90%" className="skill-meter" />
      <span className="skill-level">90%</span>
    </div>,
  ];
